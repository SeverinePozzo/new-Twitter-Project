        ...
        <div className="bg-gray-100 border w-full lg:w-1/2">
                ...
                <div className="bg-white p-6 flex items-start">
                    ...
                    <div className="flex-grow">
                        <textarea className="text-xl p-2 w-full resize-none h-36" placeholder="What's happening?"></textarea>
                        <hr/>
                        <div className="flex justify-between text-primary mt-4 items-center">
                            ...
                            <button className="bg-blue-500 text-white rounded-full px-6 py-2 text-xl">Tweet</button>
                        </div>
                    </div>
                </div>
            </div>
